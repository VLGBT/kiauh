...
function set_globals() {
  ...
  KLIPPER_REPO="https://github.com/VLGBT/klipper.git"

  #================= MOONRAKER ==================#
  MOONRAKER_ENV="${HOME}/moonraker-env"
  MOONRAKER_DIR="${HOME}/moonraker"
  MOONRAKER_REPO="https://github.com/VLGBT/moonraker.git"
  ...
  KLIPPERSCREEN_REPO="https://github.com/VLGBT/KlipperScreen.git"
